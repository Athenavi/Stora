...
-- Fix existing databases where nullable columns were incorrectly created NOT NULL
ALTER TABLE file_items ALTER COLUMN folder_id DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN filename DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN original_filename DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN file_path DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN file_url DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN mime_type DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN storage_bucket DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN storage_key DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN file_hash DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN thumbnail_url DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN width DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN height DROP NOT NULL;
ALTER TABLE file_items ALTER COLUMN duration DROP NOT NULL;
