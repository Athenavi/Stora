...
class UploadTask(Base):
    ...
    total_chunks = Column(Integer, doc='总分块数')


    uploaded_chunks = Column(Integer, default=0, doc='已上传分块数')


    file_hash = Column(String(64), nullable=True, doc='文件 SHA256 哈希')

    status = Column(String(255), default='initialized', doc='状态 (initialized/uploading/completed/canceled)')
